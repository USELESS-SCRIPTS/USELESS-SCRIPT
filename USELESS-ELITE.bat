...
echo " `--'`--'`--'`--'`--'`--'`--'`--'`--'`--'`--'`--'`--'`--'`--'`--'`--'`--'`--'`--'`--'`--' ";
@echo off
set /p inputPassword=Please enter the password: 
if "%inputPassword%"=="36241" (
    echo welcome.
	goto main
...
:servertest
cls
title RATs MultiTool - Checking a server's status
...
goto help
:buy
echo To buy you need to dm remote_access_trojan on discord for key
timeout 3 >nul
goto notice
:acc
...
echo                   ╚═══════════════════════════════════╝ 
echo                        ╔═══════════════════════╗
echo                        ║ hell, "remote_access_trojan    ║
echo                        ╚═══════════════════════╝
echo                        ╔═══════════════════════╗
echo                        ║1) pingers             ║
...
echo            ║14) tt gen and checker ║29) ADMIN              ║
...
:rats
echo dm remote_access_trojan on discord for rats
pause
goto more
...
echo dm remote_access_trojan and say "i want more backdoors"
pause 
goto more
...
:credits
echo --------------------------------
echo Multitool Design: remote_access_trojan
echo --------------------------------
echo Multitool Devved by: remote_access_trojan
echo --------------------------------
pause
goto help
